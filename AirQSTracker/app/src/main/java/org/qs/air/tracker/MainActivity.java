...
//        }
        ...
        locationManager.requestLocationUpdates(LocationManager.NETWORK_PROVIDER, 3000, 5, new LocationListener() {
                    @Override
                    public void onLocationChanged(Location location) {
                        ...
                        mPosition = mMap.addMarker(new MarkerOptions().position(position).title("AirQS Location").
                                icon(bitmapDescriptorFromVector(MainActivity.this, R.drawable.ic_raspberry_old)));
