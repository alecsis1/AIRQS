...
import org.rpi.sense.hat.api.dto.JoystickEvent;
...
public class Joystick extends APIBase {
	...
	/**
	 * Returns a list of events representing all events that have occurred since
	 * the last call to getEvents or waitForEvent
	 *
