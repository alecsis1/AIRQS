...
import org.rpi.sense.hat.api.dto.IMUData;
import org.rpi.sense.hat.api.dto.IMUDataRaw;
import org.rpi.sense.hat.connector.Command;
import org.rpi.sense.hat.utils.PythonUtils;
...
public class IMU extends APIBase {
	 ...
	 *
	 * @return Object with pitch, roll and yaw representing the angle of the
	 *         axis in degrees
	 */
	...
	/**
	 * Calls set_imu_config internally in Python core to disable the gyroscope
	 * and accelerometer then gets the direction of North from the magnetometer
	 * in degrees
	 *
	 ...
	 *
	 * @return Object representing the magnetic intensity of the axis in
	 *         microteslas (uT)
	 */
	...
	/**
	 * Calls set_imu_config internally in Python core to disable the
	 * magnetometer and accelerometer then gets the current orientation from the
	 * gyroscope only
	 *
	 * @return Object with pitch, roll and yaw representing the angle of the
	 *         axis in degrees
	 ...
	 *
	 * @return Object representing the rotational intensity of the axis in
	 *         radians per second
	 */
	...
	/**
	 * Calls set_imu_config in Python core to disable the magnetometer and
	 * gyroscope then gets the current orientation from the accelerometer only
	 *
